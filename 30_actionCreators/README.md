...
Learn how to keep code maintainable and self-documenting by extracting action creators from the components from [the video by Dan Abramov](https://egghead.io/lessons/javascript-redux-extracting-action-creators).
